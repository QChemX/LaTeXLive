...
1. Copy `js/common/runtime-config.example.js` to `js/common/runtime-config.js`.
2. Fill in your own `WXLogin.AppID`, `WXLogin.RedirectURL`, and `Analytics.GoogleUA` if needed.
3. Keep `js/common/runtime-config.js` uncommitted. It is ignored by git.
