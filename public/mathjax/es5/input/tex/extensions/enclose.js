    ...
    function (e, i, t) {
        ...
        ((i.ENCLOSE_OPTIONS = {
            ...
            (i.EncloseMethods.Enclose = function (e, t) {
                var a = e.GetArgument(t).replace(/,/g, " "),
                    n = e.GetBrackets(t, ""),
                    o = e.ParseArg(t),
                    r = u.default.keyvalOptions(n, i.ENCLOSE_OPTIONS);
                ((r.notation = a), e.Push(e.create("node", "menclose", [o], r)));
            }),
            new n.CommandMap("enclose", { enclose: "Enclose" }, i.EncloseMethods),
            (i.EncloseConfiguration = a.Configuration.create("enclose", {
