    ...
    function (t, e, a) {
        ...
        var m = {
                ...
                for (var r = 10, i = []; ;) {
                    ...
                    t: for (var p = 0; p < u.length; p++) {
                        ...
                        if (s) {
                            ...
                            if (((n = _.nextState || n), !(0 < t.length))) return i;
            ...
            patterns: {
                patterns: {
                    ...
                    amount: function (t) {
                        ...
                        var a = m.patterns.findObserveGroups(t, "", "$", "$", "");
                        return a &&
                            (e = a.match_.match(
                ...
                findObserveGroups: function (t, e, a, n, o, r, i, c, u, p) {
                    ...
                    var d = t.substring(0, n ? l.endMatchEnd : l.endMatchBegin);
                    if (r || i) {
                ...
                match_: function (t, e) {
                    var a = m.patterns.patterns[t];
                    if (void 0 === a)
                        throw ["MhchemBugP", "mhchem bug P. Please report. (" + t + ")"];
                    if ("function" == typeof a) return m.patterns.patterns[t](e);
                    var n = e.match(a);
                    return n
                        ? {
            ...
            actions: {
                ...
                "{text}": function (t, e) {
                    var a = ["{"];
                    return (m.concatArray(a, m.go(e, "text")), a.push("}"), a);
                },
        ...
        m.stateMachines = {
            ce: {
                ...
                actions: {
                    "o after d": function (t, e) {
                        ...
                        if ((t.d || "").match(/^[0-9]+$/)) {
                            var n = t.d;
                            ((t.d = void 0), (a = this.output(t)), (t.b = n));
                        } else a = this.output(t);
                        return (m.actions["o="](t, e), a);
                    },
                    "d= kv": function (t, e) {
                        ((t.d = e), (t.dType = "kv"));
                    },
                    "charge or bond": function (t, e) {
                        if (t.beginsWithBond) {
                            var a = [];
                            return (
                                m.concatArray(a, this.output(t)),
                                m.concatArray(a, m.actions.bond(t, e, "-")),
                                a
                            );
                        }
                        t.d = e;
                    ...
                    "- after o/d": function (t, e, a) {
                        var n = m.patterns.match_("orbital", t.o || ""),
                        ...
                        return (
                            c
                                ? (m.concatArray(u, this.output(t)),
                                    u.push({ type_: "hyphen" }))
                                : ((n = m.patterns.match_("digits", t.d || "")),
                                    a && n && "" === n.remainder
                    ...
                    "oxidation-output": function (t, e) {
                        var a = ["{"];
                        return (m.concatArray(a, m.go(e, "oxidation")), a.push("}"), a);
                    },
            ...
            pu: {
                ...
                actions: {
                    enumber: function (t, e) {
                        ...
                        return (
                            "+-" === e[0] || "+/-" === e[0]
                                ...
                                : e[0] && a.push(e[0]),
                            e[1] &&
                            (m.concatArray(a, m.go(e[1], "pu-9,9")),
                                e[2] &&
                                (e[2].match(/[,.]/)
                                    ? m.concatArray(a, m.go(e[2], "pu-9,9"))
                                    : a.push(e[2])),
                                (e[3] = e[4] || e[3]),
                                e[3] &&
                                ((e[3] = e[3].trim()),
                    ...
                    output: function (t) {
                        var e,
                            a = m.patterns.match_("{(...)}", t.d || "");
                        a && "" === a.remainder && (t.d = a.match_);
                        var n = m.patterns.match_("{(...)}", t.q || "");
                        if (
        ...
        var u = {
            go: function (t, e) {
                if (!t) return "";
                for (var a = "", n = !1, o = 0; o < t.length; o++) {
                    var r = t[o];
                    "string" == typeof r
                        ? (a += r)
                        : ((a += u._go2(r)), "1st-level escape" === r.type_ && (n = !0));
                }
                return (e || n || !a || (a = "{" + a + "}"), a);
            },
            _goInner: function (t) {
