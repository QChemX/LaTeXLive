    ...
    function (t, e, a) {
        ...
        ((e.UnicodeMethods.Unicode = function (t, e) {
            ...
            var u = t.stack.env.font,
                c = {};
            o
                ? ((M[r][2] = c.fontfamily = o.replace(/'/g, "'")),
                    u &&
                    (u.match(/bold/) && (c.fontweight = "bold"),
                        u.match(/italic|-mathit/) && (c.fontstyle = "italic")))
                : u && (c.mathvariant = u);
            var l = t.create("token", "mtext", c, f.numeric(i));
            (d.default.setProperty(l, "unicode", !0), t.Push(l));
        }),
