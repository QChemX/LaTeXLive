...
const zhCN = {
  ...
  previewTitle: "实时预览",
  previewHint: "MathJax 4 SVG 高质量渲染",
  rendering: "渲染中",
  invalidSyntax: "语法有误",
  synced: "已同步",
  preparing: "正在准备公式引擎…",
...
const zhTW: Record<MessageKey, string> = {
  ...
  previewTitle: "即時預覽", previewHint: "MathJax 4 SVG 高品質渲染", rendering: "渲染中", invalidSyntax: "語法有誤", synced: "已同步",
...
const en: Record<MessageKey, string> = {
  ...
  previewTitle: "Live preview", previewHint: "High-quality MathJax 4 SVG rendering", rendering: "Rendering", invalidSyntax: "Invalid syntax", synced: "Synced",
...
const ja: Record<MessageKey, string> = {
  ...
  previewTitle: "ライブプレビュー", previewHint: "高品質な MathJax 4 SVG レンダリング", rendering: "処理中", invalidSyntax: "構文エラー", synced: "同期済み",
